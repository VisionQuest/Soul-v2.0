...
public class Reports extends AppCompatActivity implements AdapterView.OnItemClickListener, MetaballMenu.MetaballMenuClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        category.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (sp1.contentEquals("Academics")) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(Reports.this, android.R.layout.simple_spinner_item, list);
                ...
                if (sp1.contentEquals("Administration")) {
                    ...
                    ArrayAdapter<String> dataAdapter2 = new ArrayAdapter<String>(Reports.this, android.R.layout.simple_spinner_item, list);
                ...
                if (sp1.contentEquals("Extra-Curricular Activities")) {
                    ...
                    ArrayAdapter<String> dataAdapter3 = new ArrayAdapter<String>(Reports.this, android.R.layout.simple_spinner_item, list);
        ...
        down2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                adapter = new CustomAdapter(Reports.this, rowItemst);
                mylistview.setAdapter(adapter);

                adapter2 = new CustomAdapter(Reports.this, rowItemst2);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (seltab) {
                    case "Text":
                        ...
                        fb_db.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                Intent i = new Intent(Reports.this, txtdisp.class);
                    ...
                    case "Image":
                        ...
                        imgprog = ProgressDialog.show(Reports.this, "Download", "Downloading Image...");
...
//                        toast.show();
                        ...
                        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Intent i = new Intent(Reports.this, imgdisp.class);
                                ImgUri.uri = uri;
                                startActivity(i);
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
                        ...
                        break;
                    case "Audio":
                        imgprog = ProgressDialog.show(Reports.this, "Download", "Downloading Audio...");
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
                        ...
                        break;
                    case "Video":
                        imgprog = ProgressDialog.show(Reports.this, "Download", "Downloading Video...");
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
                        ...
                        break;
                    case "File":
                        imgprog = ProgressDialog.show(Reports.this, "Download", "Downloading File...");
                               ...
                               final String ftype=storageMetadata.getContentType();
                                ...
                                public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        try {
                                            ...
                                            Toast.makeText(Reports.this,"Invalid File type",Toast.LENGTH_LONG).show();
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
        ...
        mylistview2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (seltab) {
                    case "Text":
                        imgprog = ProgressDialog.show(Reports.this,"Download","Downloading Text");
...
//                                            Picasso.with(Reports.this).load(uri).fit().centerCrop().into(imgg);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.menuitem2:
                seltab = "Image";
                adapter = new CustomAdapter(Reports.this, rowItemsi);
                mylistview.setAdapter(adapter);
                adapter2 = new CustomAdapter(Reports.this, rowItemsi2);
                mylistview2.setAdapter(adapter2);
                break;
            case R.id.menuitem3:
                seltab = "Audio";
                adapter = new CustomAdapter(Reports.this, rowItemsa);
                mylistview.setAdapter(adapter);
                adapter2 = new CustomAdapter(Reports.this, rowItemsa2);
                mylistview2.setAdapter(adapter2);
                break;
            case R.id.menuitem4:
                seltab = "Video";
                adapter = new CustomAdapter(Reports.this, rowItemsv);
                mylistview.setAdapter(adapter);
                adapter2 = new CustomAdapter(Reports.this, rowItemsv2);
                mylistview2.setAdapter(adapter2);
                break;
            case R.id.menuitem5:
                seltab = "File";
                adapter = new CustomAdapter(Reports.this, rowItemsf);
                mylistview.setAdapter(adapter);
                adapter2 = new CustomAdapter(Reports.this, rowItemsf2);
                mylistview2.setAdapter(adapter2);
                break;
        }
    }
    ...
    private class MyTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            imgprog = ProgressDialog.show(Reports.this, "Message", "Fetching Data...");
